...
struct event CalendarEvent[MAX_EVENTS] =
    {
        ...
        // {1, MAR, 0, "Calendar event July 1st"},
        // {1, MAR, 0, "Calendar event August 1st"},
        // {1, MAR, 0, "Calendar event September 1st"},
        // {1, MAR, 0, "Calendar event October 1st"},
        // {1, MAR, 0, "Calendar event November 1st"},
        // {1, MAR, 0, "Calendar event December 1st"},
